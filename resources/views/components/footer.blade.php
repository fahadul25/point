        ...
        <div class="container mx-auto px-6 py-4">
            <div class="lg:flex">
                <div class="w-full lg:w-2/5 -mx-6">
                    <div class="px-6">
                        <div>
                            <a href="#" class="text-xl font-bold text-gray-200 hover:text-gray-400">PointRecharge</a>
                        </div>
                ...
                <div class="mt-6 lg:mt-0 lg:flex-1">
                    <div class="grid gap-6 grid-cols-2 sm:grid-cols-3 md:grid-cols-4">
                        ...
                        <div>
                            ...
                            <a href="#" class="block mt-2 text-sm text-gray-400">Mobile TopUp</a>
                            <a href="#" class="block mt-2 text-sm text-gray-400">Sim Activation</a>
                            <a href="#" class="block mt-2 text-sm text-gray-400">Money Transfer</a>
                        </div>
            ...
            <div>
                <p class="text-center text-gray-100">© Pointrecharge 2020 - All rights reserved | Developed By Fahadul Islam</p>
            </div>
        </div>
    </footer>